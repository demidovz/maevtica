...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark для debugging среды с настоящими и ложными shift-сигналами."
    )
...
def main() -> None:
    ...
    for policy in policies:
        episodes = [
            run_episode(
                ...
                environment_factory=DebuggingAmbiguousShiftEnvironment,
                environment_kwargs={
                    "shift_after_step": 2,
    ...
    print(
        f"Environment: ambiguous_shift(step=2,min_stop=4,shift_prob={args.shift_probability},"
