...
from epistemic_engine.environments.debugging import DebuggingQuestionValueShiftEnvironment
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Пошаговая демонстрация debugging среды со сдвигом полезности вопросов."
    )
    parser.add_argument(
        "--actual",
        choices=list(DebuggingQuestionValueShiftEnvironment().hypotheses()),
        default=None,
    )
...
def main() -> None:
    args = parse_args()
    environment = DebuggingQuestionValueShiftEnvironment(
    ...
    print("Epistemic Engine MVP: debugging question-value shift diagnosis")
