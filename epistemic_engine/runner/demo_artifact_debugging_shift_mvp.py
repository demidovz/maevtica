...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Step-by-step demo for artifact-level shift environment."
    )
    parser.add_argument(
        "--actual",
        choices=list(ArtifactDebuggingQuestionValueShiftEnvironment().hypotheses()),
        default=None,
    )
...
def main() -> None:
    args = parse_args()
    environment = ArtifactDebuggingQuestionValueShiftEnvironment(
    ...
    print("Epistemic Engine MVP: artifact shift diagnosis")
