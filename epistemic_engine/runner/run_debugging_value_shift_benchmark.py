...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark для debugging среды со сдвигом полезности типов вопросов."
    )
...
def main() -> None:
    ...
    policies = [
        ...
        ReactivatingSwitchMemoryPolicy(
            ...
            type_bonus=0.05,
            switch_bonus=0.16,
            reactivation_bonus=0.14,
            type_bonus_decay=1.0,
        ),
    ...
    for policy in policies:
        episodes = [
            run_episode(
                ...
                environment_factory=DebuggingQuestionValueShiftEnvironment,
    ...
    print(
        f"Environment: question_value_shift(step=2,min_stop=3) | "
